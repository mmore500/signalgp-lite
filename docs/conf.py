...
# -*- coding: utf-8 -*-
#
# signalgp-lite documentation build configuration file, created by
...
project = u'SignalGP Lite'
copyright = u"2020, Matthew Andres Moreno"
...
htmlhelp_basename = 'signalgp-litedoc'
