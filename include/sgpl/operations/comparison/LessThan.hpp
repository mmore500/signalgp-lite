#pragma once
#ifndef SGPL_OPERATIONS_COMPARISON_LESSTHAN_HPP_INCLUDE
...
/**
 * Checks whether `reg[arg_1]` is less than `reg[arg_2]` and stores the result
 * in `reg[arg_0]`.
 */
struct LessThan {
  ...
  static std::string name() { return "Less Than"; }
...
#endif // #ifndef SGPL_OPERATIONS_COMPARISON_LESSTHAN_HPP_INCLUDE
