#pragma once
#ifndef SGPL_OPERATIONS_BITWISE_BITWISENAND_HPP_INCLUDE
#define SGPL_OPERATIONS_BITWISE_BITWISENAND_HPP_INCLUDE
...
/**
 * Performs a bitwise NAND of `reg[arg_1]` and `reg[arg_2]` then stores the
 * result in `reg[arg_0]`.
 */
struct BitwiseNand {
  ...
  static std::string name() { return "Bitwise Nand"; }
...
#endif // #ifndef SGPL_OPERATIONS_BITWISE_BITWISENAND_HPP_INCLUDE
