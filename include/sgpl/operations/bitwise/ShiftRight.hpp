#pragma once
#ifndef SGPL_OPERATIONS_BITWISE_SHIFTRIGHT_HPP_INCLUDE
#define SGPL_OPERATIONS_BITWISE_SHIFTRIGHT_HPP_INCLUDE
...
struct ShiftRight {
  ...
  static std::string name() { return "Shift Right"; }

};

} // namespace sgpl

#endif // #ifndef SGPL_OPERATIONS_BITWISE_SHIFTRIGHT_HPP_INCLUDE
